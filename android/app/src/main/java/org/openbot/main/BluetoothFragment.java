...
public class BluetoothFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @NonNull Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            EasyPermissions.with(getActivity())
                    .request(Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.BLUETOOTH_SCAN, Manifest.permission.BLUETOOTH_CONNECT)
    ...
    private void checkPermission(boolean grantAll) {
        ...
        if (grantAll) {
            ...
            Toast.makeText(getActivity().getApplicationContext(), "Please go to settings to grant location and Near by Devices permission manually", Toast.LENGTH_LONG).show();
        }
    }
